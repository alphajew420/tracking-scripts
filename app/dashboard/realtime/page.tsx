...
const wsBase = (process.env.API_PUBLIC_BASE_URL ?? "https://api.trackified.15-204-158-166.sslip.io").replace(/^http/, "ws");
  ...
  return (
    <AppShell active="/dashboard/realtime">
      ...
      <section className="panel pad">
        ...
        <pre style={{ overflow: "auto", background: "var(--ink)", color: "white", padding: 14, borderRadius: 7 }}>{`${wsBase}/v1/stream?api_key=live_...
